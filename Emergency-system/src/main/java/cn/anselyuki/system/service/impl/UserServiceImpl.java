...
import cn.anselyuki.common.model.system.*;
import cn.anselyuki.common.response.ActiveUser;
import cn.anselyuki.common.utils.JWTUtils;
...
import cn.anselyuki.system.converter.UserConverter;
import cn.anselyuki.system.mapper.*;
import cn.anselyuki.system.service.DepartmentService;
import cn.anselyuki.system.service.UserService;
import cn.anselyuki.system.shiro.JWTToken;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserMapper userMapper, UserRoleMapper userRoleMapper, RoleMapper roleMapper, UserConverter userConverter, RoleMenuMapper roleMenuMapper, MenuMapper menuMapper, DepartmentMapper departmentMapper, DepartmentService departmentService) {
    ...
    public List<MenuNodeVO> findMenu() {
        ...
        if (!CollectionUtils.isEmpty(menus)) {
            menuNodeVOList = MenuConverter.converterToMenuNodeVO(menus);
        }
        // 构建树形菜单
            ...
            for (Long rid : rids) {
                ...
                if (role.getStatus() == 0) {
                    throw new SystemException(SystemCodeEnum.PARAMETER_ERROR,
                            "roleName=" + role.getRoleName() + ",该角色已禁用");
                }
